...
class HomePageFrontCustomerRep extends Component {
    displayName = HomePageFrontCustomerRep.name
    ...
    render() {
        let contents = this.state.loading
            ? <p><em>Loading...</em></p>
            : HomePageFrontCustomerRep.renderPicture(this.state.customers);
...
export default HomePageFrontCustomerRep;
