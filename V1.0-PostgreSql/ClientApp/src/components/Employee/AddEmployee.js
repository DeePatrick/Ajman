...
class AddEmployee extends Component {
    ...
    bindDroDown(langid) {
        if (langid > 0) {
            ...
            fetch(config.webApiUrl() + "aptc_individual_getAllApprovedCompanys/" + localStorage.getItem('selectedLanguageCode') + "/" + localStorage.getItem('individualid'))
                .then(response => response.json())
                .then(data => {
                    //var compList = [];
    ...
    handleSave() {
        this.props.refreshEmployee('', 'add');
    }
    cleareData() {
        this.setState({
            languageid: 0,
    ...
    onSubmit(e) {
        ...
        axios
            .post(config.webApiUrl() + 'aptc_employee ', Individual, {
                headers: {
                    'Content-Type': 'application/json'
                }
            })
                                                                    ...
                                                                    <div className="form-group">
                                                                        <div className="bordered-loginbar ">
                                                                            <input
                                                                                ...
                                                                                className="form-control myformcontrol center "
                                                                                aria-describedby="emailHelp"
                                                                                placeholder={this.props.t('Enter_Six_Digit_Number')} />
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="row">
                                                                ...
                                                                <div className="form-group">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            className="edit-form"
                                                                            required>
                                                                            <option value="">{this.props.t('Roles')}</option>
                                                                            {this
                                                                                .state
                                                                                .rolelist
                                                                                .map(role => <option key={role.name} value={role.roleid}>{role.rolename}</option>)}
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="col-md-6 col-lg-6 col-sm-6">
                                                                <div className="form-group">
                                                                    <div className="form-group">
                                                                        <label>{this.props.t('Role_company_name')}</label>
                                                                        <select
                                                                            name="companyid"
                                                                            data-val="true"
                                                                            ...
                                                                            <option value="">{this.props.t('Company')}</option>
                                                                            {
                                                                                this.state
                                                                                    .companylist
                                                                                    .map(company => <option key={company.nameen} value={company.companyid}>{company.nameen}</option>)}
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
...
export default translate(AddEmployee);