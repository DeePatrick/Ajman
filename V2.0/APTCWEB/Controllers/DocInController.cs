...
namespace APTCWEB.Controllers
{
    ...
    public class DocInController : ApiController
    {
        ...
        public IHttpActionResult GetAll_Active_DocIn()
        {
            try
            {
        ...
        [HttpGet]
        [ResponseType(typeof(DocInOutPut))]
        public IHttpActionResult GetAll_InActive_DocIn()
        {
            try
            {
                string strQuery = @"SELECT meta().id as docInId,docClass,compID,vehID,indivID,rejReas,validTo,validFrom,
        ...
        [Route("aptc_docIn/{id}")]
        [HttpDelete]
        public IHttpActionResult DeleteDocIn(string id)
        {
            try
            {
        ...
        [HttpGet]
        [ResponseType(typeof(DocInOutPut))]
        public IHttpActionResult GetDocIn_WithMaster(string id)
        {
        ...
        [HttpGet]
        [ResponseType(typeof(DocInOutPut))]
        public IHttpActionResult GetAllDocIn_WithMaster()
        {
            string indvName = string.Empty;
            try
            {
