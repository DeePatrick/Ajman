    ...
    renderDriverPerformanceDetailList() {
        ...
        return (
            <div className="wrapper-content">
                ...
                <div className="entity-table entity-table-padding">

                    <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 panel panel-default animate-table pull-left">
                            ...
                            <div className="panel full-height">
                                ...
                                <div className="panel-body">
                                    ...
                                    <div className="container-fluid">
                                        {filteredCompanies.map((vec, index) => <div className="row" key={index} onClick={this.handleClick.bind(this, vec)}>
                    ...
                    <div className="col-lg-8 col-md-8 col-sm-0 col-xs-0 col-lg-offset-3 col-md-offset-3 col-sm-offset-12 col-xs-offset-12 panel panel-default main-body-height-admin">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div
                                                ...
                                                className="col-lg-10 col-md-8 col-sm-9 left-margin">
