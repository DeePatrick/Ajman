...
namespace APTCWebb.Controllers
{
    ...
    public class IncidentMessageController : ApiController
    {
        ...
        public IActionResult GetIncidentMessage(string id)
        {
        ...
        [HttpGet]
        [ResponseType(typeof(IncidentMessageOutPut))]
        public IActionResult GetAllIncidentMessage()
        {
        ...
        public async Task<IActionResult> RegisterIncidentMessage(IncidentMessageModel model)
        {
            try
            {
