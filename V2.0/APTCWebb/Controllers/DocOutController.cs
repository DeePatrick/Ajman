...
//        public async Task<IActionResult> Register(DocOut model)
//        {
//            try
//            {
...
//        [HttpDelete]
//        public IActionResult DeleteDocOut(string id)
//        {
//            try
//            {
...
//        [HttpPut]
//        [ResponseType(typeof(MessageModel))]
//        public async Task<IActionResult> Approved_DocOut(string id, DocOut model)
//        {
//            try
//            {
...
//        [HttpPut]
//        [ResponseType(typeof(MessageModel))]
//        public async Task<IActionResult> Update_DocOut(string Id, DocOut model)
//        {
//            try
//            {
//                if (!ModelState.IsValid)
...
//        public IActionResult GetPERMIT_WithMaster(string id)
//        {
...
//        [HttpGet]
//        [ResponseType(typeof(DocOutOutPut))]
//        public IActionResult GetAllPERMIT_WithMaster()
//        {
//            string indvName = string.Empty;
//            try
//            {
