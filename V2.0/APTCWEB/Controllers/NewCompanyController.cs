...
namespace APTCWEB.Controllers
{
    ...
    public class NewCompanyController : ApiController
    {
        ...
        public IHttpActionResult GetCompany(string CRNum)
        {
            try
            {
        ...
        public async Task<IHttpActionResult> Register(NewCompany model)
        {
            try
            {
                if (model.Name == null)
        ...
        [HttpPut]
        [ResponseType(typeof(MessageModel))]
        public async Task<IHttpActionResult> UpdateCompany(NewCompany model)
        {
            try
            {
                if (model.Name == null)
        ...
        [HttpDelete]
        [ResponseType(typeof(MessageModel))]
        public IHttpActionResult DeleteCompany(string CRNum)
        {
            try
            {
        ...
        public IHttpActionResult GetAllCompanyName()
        {
            try
            {
        ...
        public IHttpActionResult GetCompanyVehicles(string CRNum)
        {
            try
            {
        ...
        public IHttpActionResult GetCompanyEmployees(string CRNum)
        {
            try
            {
        ...
        [HttpGet]
        public IHttpActionResult GetCompanyEmployeesCount(string CRNum)
        {
            try
            {
                string query = string.Empty; 
        ...
        [HttpGet]
        [ResponseType(typeof(CompanyVehicleOutPut))]
        public IHttpActionResult GetCompanyPendingPermits(string CRNum)
        {
            try
            {
        ...
        [HttpGet]
        [ResponseType(typeof(CompanyVehicleOutPut))]
        public IHttpActionResult GetCompanyApprovedPermits(string CRNum)
        {
            try
            {
        ...
        [HttpGet]
        [ResponseType(typeof(CompanyVehicleOutPut))]
        public IHttpActionResult GetCompanysPermits(string CRNum)
        {
            try
            {
                string indvName = string.Empty;
        ...
        [HttpPut]
        [ResponseType(typeof(MessageModel))]
        public async Task<IHttpActionResult> ApprovedCompany(string CRNum)
        {
            try
            {
