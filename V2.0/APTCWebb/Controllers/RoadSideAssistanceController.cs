...
namespace APTCWebb.Controllers
{
    ...
    public class RoadSideAssistanceController : ApiController
    {
        ...
        public IActionResult GetRoadSideAssistance(string id)
        {
        ...
        [HttpGet]
        [ResponseType(typeof(RoadsideAssistanceOutPut))]
        public IActionResult GetAllRoadSideAssistance()
        {
        ...
        public async Task<IActionResult> RegisterDriverStatus(RoadsideAssistanceModel model)
        {
            try
            {
