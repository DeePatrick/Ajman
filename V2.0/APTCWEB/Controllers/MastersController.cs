...
namespace APTCWEB.Controllers
{
    ...
    public class MastersController : ApiController
    {
        ...
        [HttpGet]
        public IHttpActionResult GetStateOfCountry(string countryCode)
        {
        ...
        [HttpGet]
        public IHttpActionResult GetModelOfVehMake(string vehMakeCode)
        {
        ...
        [HttpGet]
        public IHttpActionResult GetPlateMasters()
        {
        ...
        [HttpGet]
        public IHttpActionResult GetPlateCountryMasters()
        {
            string query = @"SELECT plateCountry From " + _bucket.Name + " as cmt where meta().id='Plate_EN'";
            var CommonMasterDocument = _bucket.Query<object>(query).ToList();
            return Content(HttpStatusCode.OK, CommonMasterDocument);
        ...
        [HttpGet]
        public IHttpActionResult GetPlateTypeOfCountry(string platecountryCode)
        {
        ...
        //[HttpGet]
        //public IHttpActionResult GetPlateCategoryOfPlateType(string plateTypeCode)
        //{
