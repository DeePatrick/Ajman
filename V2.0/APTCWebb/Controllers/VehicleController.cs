...
namespace APTCWebb.Controllers
{
    ...
    //    public async Task<IActionResult> RegisterDriver(Vehicle model)
    //    {
    //        try
    //        {
    ...
    //    [HttpPost]
    //    public async Task<IActionResult> Update(Vehicle model)
    //    {
    //        try
    //        {
    ...
    //    [HttpGet]
    //    public IActionResult BindVehicleTypeDDL()
    //    {
    ...
    //    [HttpGet]
    //    public IActionResult BindColourDDL()
    //    {
    ...
    //    [HttpGet]
    //    public IActionResult BindMakeDDL()
    //    {
    ...
    //    [HttpGet]
    //    public IActionResult BindModelDDL(int id)
    //    {
