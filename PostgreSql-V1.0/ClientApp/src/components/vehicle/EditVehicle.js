...
class EditVehicle extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.mode === 'edit') {
            this.setState({ loading: true, companyid: nextProps.companyid, vehicleid:nextProps.vehicleid });
    ...
    bindDroDown(languageid) {
        ...
        fetch(config.webApiUrl() + "aptc_company_getEmployees/" + localStorage.getItem('selectedLanguageCode') + "/" + this.state.companyid)
            .then(response => response.json())
            .then(data => {
                        ...
                        fetch(config.webApiUrl() + "aptc_getVehicleMakeModel/" + this.state.languageid + "/" + vehicle.makeid)
                            ...
                            .then(data => {
                                ...
                                this.setState({
                                    ...
                                    companyname: vehicle.ownershipname,
    ...
    bindOwnership(ownershipType) {
        ...
        if (ownershipType === "IND") {
            ...
            owner.companyid = this.state.companyid;
            owner.nameen = this.state.companyname;
            owner.namear = "";
    ...
    handleSave() {
        this.props.saveModalDetails(this.state.vehicleid, 'edit');
    }
