...
namespace APTCWEB.Controllers
{
    ...
    public class ObjectsController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult IndividualAddRole([FromUri]string id, Roles model)
        {
            try
            {
        ...
        [HttpPost]
        public IHttpActionResult IndividualAddDocument([FromUri]string id, Documents model)
        {
            try
            {
        ...
        [HttpPost]
        public IHttpActionResult IndividualAddVehicle([FromUri]string id, Vehicles model)
        {
            try
            {
        ...
        [HttpPost]
        public IHttpActionResult IndividualAddIncident([FromUri]string id, Incidents model)
        {
            try
            {
        ...
        [HttpPost]
        public IHttpActionResult CompanyAddDocument([FromUri]string id, Documents model)
        {
            try
            {
        ...
        [HttpPost]
        public IHttpActionResult CompanyAddVehicle([FromUri]string id, Vehicles model)
        {
            try
            {
                bool isThisVehicleExist = false;
        ...
        [HttpPost]
        public IHttpActionResult StaffAddDocument([FromUri]string id, Documents model)
        {
            try
            {
        ...
        [HttpGet]
        public IHttpActionResult GetIndividual_Item_Count(string id,string name)
        {
