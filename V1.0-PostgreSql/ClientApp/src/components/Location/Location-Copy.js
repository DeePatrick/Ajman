...
import GMap from './MapLocation/MapLocation';
import * as config from '../../config';

class Location1 extends Component {
    displayName = Location1.name
    ...
    constructor(props) {
        ...
        var temp = [];
        fetch(config.webApiUrl() + 'aptc_individual_getAllActiveCompanysDrivers_DriverStatus/' + localStorage.getItem('emirtaiId'))
...
export default connect()(Location1);