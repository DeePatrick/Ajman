...
class AttendedQuotationRequest extends Component {
    constructor() {
        super();
        this.state = {
            name: '',
                                        ...
                                        <div className="col-md-1 col-lg-1 col-sm-2 col-xs-3">
                                            <span
                                                onClick={this
                                                    .handleClick
                                                    .bind(this, cus)}>
                                                <i id="" className="far fa-file-alt circle-pending" />
                                            </span>
...
export default AttendedQuotationRequest;