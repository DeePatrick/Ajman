...
class Enquiry extends Component {
    ...
    _renderSubComp() {
        switch (this.state.render) {
            case 'violations': return <div className="slideright"><Violations/></div>
            case 'complaints': return <div className="slidebottom"><Complaints/></div>
            case 'issuerequest': return <div className="slideright"><IssueRequest/></div>
            case 'receipt': return <div className="slidebottom"><InvoiceReceiptRequest/></div>
            case 'quotation': return <div className="slideright"><QuotationRequest/></div>
            default: return <div className="slidebottom"><QuotationRequest/></div>
        }
    }
                ...
                <div className="row">
                    <div className="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <Animated animationIn="bounceIn" animationOut="fadeOut" isVisible={true}>
                            <div className="well search-well enquiry">
                                <div className="rows">
...
export default connect()(Enquiry);