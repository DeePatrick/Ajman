...
class RequestPermit extends Component {
    ...
    componentWillMount() {
        ...
        fetch("http://103.69.38.2:8081/api/aptc_individualName")
            ...
            .then(data => {
                ...
                this.setState({ indListPermit: tempList, loading: false });
            });
    ...
    handleSubmit(e) {
        ...
        axios
            .post('http://103.69.38.2:8081/api/aptc_docOut', doc, {
                headers: {
            ...
            .then(alert("Permit form has been saved! "))
    ...
    render() {
        console.log(this.state.permitList);
        return (
            <div id="close">
                <div
                    className="modal"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select
                                            ...
                                            {this
                                                .state
                                                .vehListPermit
                                                .map((vehList, index) => <option key={index} value={vehList.keyID}>{vehList.trafficNum}&nbsp;{vehList.makeModel}
                                        ...
                                        <label htmlFor="documents">Upload Documents</label>&nbsp;
                                        {
                                            this.state.docFile.map((doc, idx) => (
                                                <div className="shareholder" key={idx}>
                                                    ...
                                                    <button type="button" onClick={this.handleRemoveDocs(idx)} className="small"><i className="fa fa-trash-alt" multiple /></button>
                                                </div>
                                            ))}
