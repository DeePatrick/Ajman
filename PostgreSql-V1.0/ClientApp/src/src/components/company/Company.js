...
import CompanyVehicles from '../vehicle/CompanyVehicles';
...
class Company extends Component {
    ...
    approveOuter = (index) => {
        ...
        if (!window.confirm("Are you sure you want to approve " + _name + " ?"))
            ...
            axios.put(config.webApiUrl() + 'aptc_company_approved', approval, {
                headers: {
    ...
    rejectOuter = (index) => {
        ...
        if (valueObject.rejectreason) {
            ...
            obj.rejectreason = "No record found...";
        }
        obj.id = id;
        ...
        return (
            <div className="wrapper-content">
                {this.state.redirectCompany
                    ...
                    : null}
                {this.state.isAddOpen === true && <AddCompany saveModalDetails={this.saveModalDetails} />
                }
                ...
                {this.state.isEditOpen === true && <EditCompany
                    ...
                    establishmentdate={modalData.establishmentdate}
                    franchisee={modalData.franchisee}
                    nameen={modalData.nameen}
                    namear={modalData.namear}
                    telephonearea={modalData.telephonearea}
                    telephonecountry={modalData.telephonecountry}
                ...
                {this.state.isModelViewOpen === true && <CompanyObjectView
                    crnumber={modalData.crnumber}
                    dedid={modalData.dedid}
                    ded={modalData.ded}
                    chambernumber={modalData.chambernumber}
                                                                            ...
                                                                            <ul
                                                                                ...
                                                                                <li className="dropdown-spacing table-dropdown-small-width">
                                                                                    <button
                                                                                        ...
                                                                                        onClick={() => this.replaceModalItem(index, 'edit', vec.companyid)}>Edit Details</button>
                                                                                </li>
                                                                                <li className="dropdown-spacing table-dropdown-small-width">
                                                                                    <button
