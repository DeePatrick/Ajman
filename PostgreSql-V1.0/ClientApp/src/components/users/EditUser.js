...
class EditUser extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({
            ...
            confirmpassword: nextProps.password,
    ...
    fileSelectedHandler(e) {
        if (e.target.files && e.target.files[0]) {
            ...
            reader.onload = (e) => {
                this.setState({ userphoto: e.target.result, filename: file.name });
            };
    ...
    handleSave = () => {
        ...
        this.props.saveModalDetails(this.state.userid, 'edit');
    }
    ...
    saveUser(e) {
        ...
        objUser.modifyby = localStorage.getItem('userid');
        objUser.username = this.state.username;
        objUser.filename = this.state.filename;
                ...
                <div
                    ...
                    <div className="modal-dialog modal-xl" role="document">
                        <div className="modal-content">
                            ...
                            <form name="form" onSubmit={this.saveUser}>
