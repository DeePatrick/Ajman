...
//using APTCWebb.Data;
//using APTCWebb.Library.DataAccess;
...
//        [Route("aptc_ica/{id}")]
//        [HttpGet]
//        public IActionResult GetICARecord(string id)
//        {
//            try
//            {
...
//                {
//                    return MessageModel Content(HttpStatusCode.NoContent, "175-please enter valid emiratid");
//                }
//                else
//                {
...
//        public IActionResult GetIndividual(string email)
//        {
//            try
//            {
...
//                }
//                return ((IActionResult)userDetails);
//            }
//            catch (Exception ex)
//            {
//                return Content(HttpStatusCode.InternalServerError, MessageResponse.Message(HttpStatusCode.InternalServerError.ToString(), ex.StackTrace), new JsonMediaTypeFormatter());
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetIndividualByEmirati(string emirati)
//        {
//            try
//            {
//                IndividualOutPut userDetails = new IndividualOutPut();
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetAllIndividual()
//        {
//            try
//            {
...
//        public IActionResult IndividualRegister(Individual model)
//        {
...
//        [HttpPut]
//        [ResponseType(typeof(MessageModel))]
//        public async Task<IActionResult> Updateindividual(Individual model)
//        {
//            try
//            {
//                // Validate Model
...
//        [HttpDelete]
//        [ResponseType(typeof(MessageModel))]
//        public IActionResult DeleteIndividual(string email)
//        {
...
//        public IActionResult GetAllIndividual_DriverStatus()
//        {
//            try
//            {
...
//        public IActionResult GetAllIndividual_Incidents()
//        {
//            try
//            {
...
//        public IActionResult GetAllIndividual_ScoreCards()
//        {
//            try
//            {
...
//        public IActionResult GetAllIndividual_Fines()
//        {
//            try
//            {
...
//        public IActionResult GetAllIndividual_Documents()
//        {
//            try
//            {
...
//        public IActionResult GetAllIndividual_Vehicles()
//        {
//            try
//            {
...
//        public IActionResult GetAllIndividualName()
//        {
//            try
//            {
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetindividualCompanys(string keyID)
//        {
//            try
//            {
//                string query = string.Empty;
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetIndividualAllActiveCompanysEmployees(string keyID)
//        {
//            try
//            {
//                string query = string.Empty;
...
//        public IActionResult GetAllActiveVehicles(string keyID)
//        {
//            try
//            {
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetIndividualAllCompanysDrivers_DriverStatus(string keyID)
//        {
//            try
//            {
//                string query = string.Empty;
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetIndividualAllCompanysDrivers_ScoreCards(string keyID)
//        {
//            try
//            {
//                string query = string.Empty;
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetIndividualAllCompanysDrivers_Incidents(string keyID)
//        {
//            try
//            {
//                string query = string.Empty;
...
//        [HttpGet]
//        [ResponseType(typeof(IndividualOutPut))]
//        public IActionResult GetIndividualAllActiveCompanysPermits(string keyID)
//        {
//            try
//            {
//                string query = string.Empty;
...
//        [HttpPut]
//        [ResponseType(typeof(MessageModel))]
//        public async Task<IActionResult> ApprovedIndividual(string keyID)
//        {
//            string query = string.Empty;
//            try
//            {
