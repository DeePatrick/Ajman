                ...
                <div>
                    ...
                    <RenewPermit
                        ...
                        saveModalDetails={this.saveModalDetails} /> {showing
                            ? <div className="row">
                            <Animated animationIn="bounceInLeft" style={{ width: '100%' }} animationOut="fadeOut" isVisible={true}>
                                    <div className="panel1 panel-default1">
                                    <div className="panel1 panel-body1" style={{marginLeft:'20px'}}>
                                            <br />
                                        ...
                                        {this.state.vec.docOutId !== undefined && <div>
                                            ...
                                            <div>
                                                ...
                                                <div className='col-lg-3 col-md-4 col-sm-3 right-border'>
                                                    <span className='pics'>
                                                        <i id="icon-ticket-alt-old-big" className="fa fa-ticket" />
                                                    </span>
                                                </div>
