                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-md-5 col-lg-5 col-sm-5">
                                                                    <div className="col-md-4 col-lg-4 col-sm-12">
                                                                        <button type="button" className="btn-delete1" onClick={this.handleRemoveCompanyActivities(idy)}
                                                                           id="btnDelete"><i className="fa fa-trash" />&nbsp;Delete</button>
                                                                    </div>
                                                                    <div className="col-md-5 col-lg-5 col-sm-5">
                                                                        <button
                                                                            ...
                                                                            style={{
                                                                                width: '170px'
                                                                            }}><i className="fa fa-plus" />&nbsp;Add more activities</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
