...
class AttendedInvoiceRecieptRequest extends Component {
    constructor() {
        super();
        this.state = {
            name: '',
                    ...
                    <div className="panel panel-default search-input-wrapper">
                        <div className={(localStorage.getItem('selectedLanguageCode') == 1) ? "panel-body search-input" : "panel-body search-input rtl-flip"}>
                            <input
                                ...
                                placeholder="Search Invoice Reciept Requests..."
                    ...
                    <div className="content-scroll">
                        <div className="col-md-12 col-lg-12">
                            <div className={(localStorage.getItem('selectedLanguageCode') == 1) ? "" : "rtl-flip"}>
                                Attended Invoice Reciept Requests
                                </div>
                                        ...
                                        <div className="col-md-1 col-lg-1 col-sm-2 col-xs-3">
                                            <span
                                                onClick={this
                                                    .handleClick
                                                    .bind(this, cus)}>
                                                <i id="" className="far fa-file-alt circle-pending"></i>
                                            </span>
...
export default AttendedInvoiceRecieptRequest;