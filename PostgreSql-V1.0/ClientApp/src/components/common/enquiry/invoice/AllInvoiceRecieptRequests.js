...
class AllInvoiceRecieptRequests extends Component {
    constructor() {
        super();
        this.state = {
            name: '',
                    ...
                    <div className="panel panel-default search-input-wrapper">
                        <div className={(localStorage.getItem('selectedLanguageCode') == 1) ? "panel-body search-input" : "panel-body search-input rtl-flip"}>
                            <input
                                ...
                                placeholder="Search All Invoice Reciept Requestss..."
...
export default AllInvoiceRecieptRequests;