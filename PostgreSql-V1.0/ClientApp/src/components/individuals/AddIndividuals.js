...
class AddIndividual extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (localStorage.getItem('selectedLanguageCode') !== null) {
            ...
            this.setState({ createdby: localStorage.getItem('userid'), companyid: nextProps.companyid});
    ...
    handleSave() {
        this.props.saveModalDetails('', 'add');
    }
    cleareData() {
        this.setState({
            languageid: 0,
...
export default translate(AddIndividual);