...
import EditAccount from '../people/EditPerson';
...
class People extends Component {
            ...
            .then(data => {
                ...
                if (mode === 'edit') {
                    for (var i = 0; i < data.length; i++) {
                        if (peopleid === data[i].individualid) {
    ...
    editAccount = (individualid) => {
        this.setState({ individualid: individualid });
        this.setState({ isEditOpen: true, mode: 'edit' });
    };
    deleteAcount(individualid,name) {
        if (!window.confirm("Do you want to delete person with Id: " + name))
            return;
        else {
            var url = config.webApiUrl() + 'aptc_individual/' + individualid;
    ...
    refreshIndividual = (individualid, mode) => {
        this.setState({ individualid: individualid, mode: mode });
        this.bindPeople(individualid, mode);
    };
    ...
    renderCompanyList() {
        ...
        return (
            <div className="wrapper-content">
                                                        ...
                                                        <td scope="row" className={localStorage.getItem('selectedLanguageCode') == 1 ? "more-item" : "rtl-more-item"}>
                                                            <div className="dropdown">
                                                                ...
                                                                {isDesktop ? (<ul className="dropdown-menu dropdown-menu3 dropdown-inverse pull-right" aria-labelledby="dropdownMenu4">
                                                                    <li onClick={(e) => this.editAccount(vec.individualid)} className="dropdown-spacing table-dropdown-small-width">
                                                                        <button id="call" data-toggle="modal" data-target="#editAccountModal"
                                                                            >Edit </button>
                                                                    </li>
                                                                    <li className="dropdown-spacing table-dropdown-small-width">
                                                                        <button className={!this.state.show ? "" : this.state.show} onClick={(e) => this.deleteAcount(vec.individualid, vec.nameen)}>Delete</button>
                                                                    </li>
                                                                </ul>) :
                                                                    (<ul className="dropdown-menu dropdown-menu3 dropdown-inverse pull-right" aria-labelledby="dropdownMenu4">
                                                                        <li onClick={(e) => this.editAccount(vec.individualid)} className="dropdown-spacing table-dropdown-small-width">
                                                                            <button id="call" data-toggle="modal" data-target="#editAccountModal">Edit Details</button>
                                                                        </li>
                                                                        <li className="dropdown-spacing table-dropdown-small-width">
                                                                            <button className={!this.state.show ? "" : this.state.show} onClick={(e) => this.deleteAcount(vec.individualid, vec.nameen)}>Delete</button>
                                                                        </li>
                                    ...
                                    <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible>
                                        ...
                                        <div className={localStorage.getItem('selectedLanguageCode') == 1
                                            ...
                                            <div
                                                ...
                                                className="col-lg-9 col-md-12 col-sm-6 left-margin pull-right">
                                                <div className={localStorage.getItem('selectedLanguageCode') == 1
                                                    ? "pull-right"
                                                    : ""}>
                                                ...
                                                <div className={localStorage.getItem('selectedLanguageCode') == 1
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => this.editAccount(this.state.vec.individualid)}
                                                    >
                                                    ...
                                                    <button
                                                        className={localStorage.getItem('selectedLanguageCode') == 1
                                                            ? "black-margin action"
                                                            : "black-margin rtl-black-margin action "}
                                                        onClick={(e) => this.deleteAcount(this.state.vec.individualid, this.state.vec.nameen)}
                                                   >
                ...
                <EditAccount mode={this.state.mode} individualid={this.state.individualid} refreshIndividual={this.refreshIndividual} />
                <Create mode={this.state.mode} refreshIndividual={this.refreshIndividual}/>
            </div>
        );
    }
